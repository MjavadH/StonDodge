...
##- Constants -----------------------------------------------------------------##
const BULLET_SCENE = preload("res://Player/Weapons/Projectiles/EmeraldWyrm_bullet.tscn")
const SHOOT_SOUND = preload("res://Player/Weapons/Projectiles/assets/Emerald-Wyrm_bullet_sound.ogg")
